...
type
  ...
  public
    constructor Create(AZMQContext:Pointer; CreateSuspended: Boolean = True); overload;
...
constructor TZMQRequestsThread.Create(AZMQContext: Pointer;
